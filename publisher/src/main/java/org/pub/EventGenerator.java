...
import org.pub.dto.MessageObject.MessageObject.Temperatura;
    ...
    private void spamEventMessage(EventPublisher publisher, int id) {
        ...
        while (true) {
            try {
                ...
                // Toma el tiempo epoch actual en milisegundos
                long epochTime = java.time.Instant.now().toEpochMilli();
