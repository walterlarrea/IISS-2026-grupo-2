package org.example.dto.serializer;
...
public class CustomSerializer {
    ...
    public static class TwoDecimalSerializer extends JsonSerializer<Float> {
        @Override
        public void serialize(Float value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
            if (value != null) {
                // Aplica formato "%.2f" y escribe el resultado como texto
